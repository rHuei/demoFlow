...
const handlebarsNode = require('../nodes/handlebars/handlebars');
...
describe('simple-test', () => {
  ...
  it('should load', (done) => {
    const flow = [{id:'n1', type:'handlebars', name:'handlebars'}];
    helper.load(handlebarsNode, flow, () => {
      let n1 = helper.getNode('n1');
      n1.should.have.property('name', 'handlebars');
      assert.equal(n1.name, 'handlebars', 'The default name should be handlebars');
      done();
    });
  });
  ...
  it('should set values using dot notation', () => {
    const testPromise = new Promise((resolve,reject) => {
      const flow = [
        {id:"n1", type: "handlebars", name:"test-node", wires:[["n2"]], query:"Hello {{name}}! Happy {{age}} birthday!",
  ...
  it('should work directly on the payload', (done) => {
    const flow = [
      {id:"n1", type: "handlebars", name:"test-node", wires:[["n2"]], query:"Hello {{person.name}}! Happy {{person.age}} birthday!",
